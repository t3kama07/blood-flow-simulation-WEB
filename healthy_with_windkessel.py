...
def run_healthy_with_windkessel():
...
plt.show()
    ...
    return t_hist, P_out_hist, Q_out_hist_rec, P_wk_hist, A_hist_multi, Q_hist_multi, P_hist_multi, labels, mmHg_to_Pa

def plot_healthy_with_windkessel(t_hist, P_out_hist, Q_out_hist_rec, P_wk_hist, A_hist_multi, Q_hist_multi, P_hist_multi, labels, mmHg_to_Pa):
